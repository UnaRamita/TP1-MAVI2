...
void staticObjects::init() {
	...
	groundBox.SetAsBox(objSize.x / 2.0f, objSize.y / 2.0f);
	//propiedades
...
void staticObjects::draw() {
	//primer llave es el rectangle, segunda llave es el origen de donde se dibuja dsp chequeo que se vea donde quiero capaz le estoy errando
